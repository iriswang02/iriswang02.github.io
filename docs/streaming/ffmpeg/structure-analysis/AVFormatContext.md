...
This structure describes data used for muxing(`avformat_write_header()`) and demuxing(`avformat_open_input()`).
...
Input is a file: `int64_t duration` & `char filename[1024]`

Input is url: `int bit_rate` & `char *url`
